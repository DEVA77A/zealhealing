  ...
  const getLocation = () => {
    return new Promise((resolve, reject) => {
      if (!navigator.geolocation) {
        ...
        // Called immediately inside the event handler to preserve user gesture
    ...
    try {
      ...
      if (locationPromise) {
        ...
        try {
          ...
          // If the user blocks geolocation, we run IP detection from the frontend so browser VPN extensions work!
          try {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 flex items-center justify-center bg-sage-50 px-4">
      ...
      >
        ...
        <h2 className="text-3xl font-serif font-bold text-center text-darkGreen mb-8">Welcome Back</h2>
